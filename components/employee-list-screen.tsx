...
export default function EmployeeListScreen() {
  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      ...
      try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/employees/getAllEmployees`, {
          method: "GET",
          headers: {
  ...
  const fetchInactiveEmployees = async () => {
    ...
    try {
      const token = localStorage.getItem("auth") ? JSON.parse(localStorage.getItem("auth")!).token : null
      const response = await fetch(`${API_BASE_URL}/api/employees/getAllInactiveEmployees`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          ...(token && { Authorization: `Bearer ${token}` }),
  ...
  const handleDeleteEmployee = async (id: string) => {
    ...
    try {
      const token = localStorage.getItem("auth") ? JSON.parse(localStorage.getItem("auth")!).token : null
      const response = await fetch(`${API_BASE_URL}/api/employees/deleteEmployee/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          ...(token && { Authorization: `Bearer ${token}` }),
  ...
  const handleStatusChange = async (id: string, newStatus: string) => {
    ...
    try {
      ...
      const token = localStorage.getItem("auth") ? JSON.parse(localStorage.getItem("auth")!).token : null
      const response = await fetch(`${API_BASE_URL}/api/employees/${id}/status?value=${apiStatus}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          ...(token && { Authorization: `Bearer ${token}` }),
  ...
  const handleViewHistory = async (employee: Employee) => {
    ...
    try {
      const token = localStorage.getItem("auth") ? JSON.parse(localStorage.getItem("auth")!).token : null
      const response = await fetch(`${API_BASE_URL}/api/employees/${employee.id}/history`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          ...(token && { Authorization: `Bearer ${token}` }),
  ...
  const handleSyncPhotos = async () => {
    try {
      ...
      const token = localStorage.getItem("auth") ? JSON.parse(localStorage.getItem("auth")!).token : null
      const response = await fetch(`${API_BASE_URL}/api/employees/sync-photos`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          ...(token && { Authorization: `Bearer ${token}` }),

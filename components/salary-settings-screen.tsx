...
export function SalarySettingsScreen() {
  ...
  return (
    <div className="p-6 space-y-6 text-slate-900 dark:text-slate-100">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100">Salary Settings</h1>
        <p className="text-gray-500 dark:text-slate-400 mt-1">Configure shift salary and OT rates</p>
      </div>
